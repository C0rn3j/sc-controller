...
class TestSpecialActions:
	...
	def test_dialog(self):
		...
		back to same action.
		"""
		assert _parses_as_itself(DialogAction("Some Text", NameModifier("Option", OSDAction("display this"))))
		assert _parses_as_itself(
			DialogAction(SCButtons.X, "Some Text", NameModifier("Option", OSDAction("display this")))
		)
		assert _parses_as_itself(
			DialogAction(SCButtons.X, SCButtons.Y, "Some Text", NameModifier("Option", OSDAction("display this")))
		)
		assert _parses_as_itself(
			DialogAction(SCButtons.X, SCButtons.Y, "Some Text", NameModifier("Option", OSDAction("display this")))
		)
